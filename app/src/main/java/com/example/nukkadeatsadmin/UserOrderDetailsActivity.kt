...
class UserOrderDetailsActivity : AppCompatActivity() {
    ...
    private fun getDataFromIntent() {
        ...
        receivedOrderDetails?.let { orderDetails ->
            ...
            foodNames = (receivedOrderDetails.foodNames ?: arrayListOf()) as ArrayList<String>
            foodImages = (receivedOrderDetails.foodImages ?: arrayListOf()) as ArrayList<String>
            foodPrices = (receivedOrderDetails.foodPrices ?: arrayListOf()) as ArrayList<String>
            foodQuantities =
                (receivedOrderDetails.foodQuantities ?: arrayListOf()) as ArrayList<Int>
